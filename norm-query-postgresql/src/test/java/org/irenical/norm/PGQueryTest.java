...
public class PGQueryTest {
  ...
  public void testExpression() {
    ...
    PGExpression condition = PGQuery.expression("age").gt(20).and(PGQuery.expression("name").ilike("%joe%").or("surname").ilike("%joe%"));
    ...
    SelectTemplate select = PGQuery.select("count(id)").from("dudes").where(condition);
